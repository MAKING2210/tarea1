    ...
    public void VaciarEstanque(int litros) {
        if (litros > 0) {
            if (nivelEstanque - litros >= 0) {
                ...
                System.out.println("No se pueden vaciar tantos litros, el estanque debe tener al menos 0 litros.");
            }
        } else {
            System.out.println("La cantidad de litros a vaciar debe ser mayor que 0.");
        }
    }
